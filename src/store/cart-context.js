...
const CartContext = React.createContext({
    items: [], // these all all default values of context API even these are no use but these are usefull for autocompletion that's why we have to give default values
